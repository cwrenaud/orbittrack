...
from limits.storage import (
    MemoryStorage, MemcachedStorage, MongoDBStorage,
    RedisClusterStorage, RedisStorage, RedisSentinelStorage
)
from limits.strategies import (
    MovingWindowRateLimiter, FixedWindowRateLimiter,
...
from orbittrack.spacetrack.exceptions import SpaceTrackRateLimitExceededError
...
class SpaceTrackUtils:
    ...
    @classmethod
    def get_minute_rate_limit(cls):
        return cls._minute_rate_limit

    @classmethod
    def get_hourly_rate_limit(cls):
    ...
    @classmethod
    def set_ratelimiter(cls, ratelimiter: MovingWindowRateLimiter | FixedWindowRateLimiter | SlidingWindowCounterRateLimiter) -> None:
        """
    ...
    @classmethod
    def set_ratelimit_storage(cls, storage: MemoryStorage | MemcachedStorage | MongoDBStorage | RedisClusterStorage | RedisStorage | RedisSentinelStorage) -> None:
        """
